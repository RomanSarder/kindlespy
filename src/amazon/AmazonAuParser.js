...
function AmazonAuParser(){
    ...
    this.estSalesScale = [
        {min: 1, max: 5, estSale: 7800 },
        {min: 6, max: 10, estSale: 6825 },
        {min: 11, max: 20, estSale: 5850 },
        {min: 21, max: 35, estSale: 4875 },
        {min: 36, max: 100, estSale: 3575 },
        {min: 101, max: 200, estSale: 1950 },
        {min: 201, max: 350, estSale: 780 },
        {min: 351, max: 500, estSale: 390 },
        {min: 501, max: 750, estSale: 292 },
        {min: 751, max: 1500, estSale: 214 },
        {min: 1501, max: 3000, estSale: 165 },
        {min: 3001, max: 4000, estSale: 136 },
        {min: 4001, max: 5000, estSale: 110 },
        {min: 5001, max: 6000, estSale: 97 },
        {min: 6001, max: 7000, estSale: 81 },
        {min: 7001, max: 8000, estSale: 65 },
        {min: 8001, max: 9000, estSale: 48 },
        {min: 9001, max: 10000, estSale: 39 },
        {min: 10001, max: 12000, estSale: 27 },
        {min: 12001, max: 15000, estSale: 22 },
        {min: 15001, max: 17500, estSale: 20 },
        {min: 17501, max: 20000, estSale: 18 },
        {min: 20001, max: 25000, estSale: 15 },
        {min: 25001, max: 30000, estSale: 13 },
        {min: 30001, max: 35000, estSale: 9 },
        {min: 35001, max: 50000, estSale: 7 },
        {min: 50001, max: 65000, estSale: 3 },
        {min: 65001, max: 80000, estSale: 1 },
