...
function AmazonFrParser(){
    ...
    this.estSalesScale = [
        {min: 1, max: 5, estSale: 24600},
        {min: 6, max: 10, estSale: 21525},
        {min: 11, max: 20, estSale: 18450},
        {min: 21, max: 35, estSale: 15375},
        {min: 36, max: 100, estSale: 11275},
        {min: 101, max: 200, estSale: 6150},
        {min: 201, max: 350, estSale: 2460},
        {min: 351, max: 500, estSale: 1230},
        {min: 501, max: 750, estSale: 922},
        {min: 751, max: 1500, estSale: 676},
        {min: 1501, max: 3000, estSale: 523},
        {min: 3001, max: 4000, estSale: 430},
        {min: 4001, max: 5000, estSale: 349},
        {min: 5001, max: 6000, estSale: 308},
        {min: 6001, max: 7000, estSale: 256},
        {min: 7001, max: 8000, estSale: 205},
        {min: 8001, max: 9000, estSale: 154},
        {min: 9001, max: 10000, estSale: 123},
        {min: 10001, max: 12000, estSale: 88},
        {min: 12001, max: 15000, estSale: 72},
        {min: 15001, max: 17500, estSale: 64},
        {min: 17501, max: 20000, estSale: 58},
        {min: 20001, max: 25000, estSale: 50},
        {min: 25001, max: 30000, estSale: 41},
        {min: 30001, max: 35000, estSale: 29},
        {min: 35001, max: 50000, estSale: 22},
        {min: 50001, max: 65000, estSale: 10},
        {min: 65001, max: 80000, estSale: 16},
