...
function AmazonDeParser(){
    ...
    this.estSalesScale = [
        {min: 1, max: 5, estSale: 34000},
        {min: 6, max: 10, estSale: 29750},
        {min: 11, max: 20, estSale: 25500},
        {min: 21, max: 35, estSale: 21250},
        {min: 36, max: 100, estSale: 15583},
        {min: 101, max: 200, estSale: 8500},
        {min: 201, max: 350, estSale: 3400},
        {min: 351, max: 500, estSale: 1700},
        {min: 501, max: 750, estSale: 1275},
        {min: 751, max: 1500, estSale: 935},
        {min: 1501, max: 3000, estSale: 722},
        {min: 3001, max: 4000, estSale: 595},
        {min: 4001, max: 5000, estSale: 482},
        {min: 5001, max: 6000, estSale: 425},
        {min: 6001, max: 7000, estSale: 354},
        {min: 7001, max: 8000, estSale: 283},
        {min: 8001, max: 9000, estSale: 212},
        {min: 9001, max: 10000, estSale: 170},
        {min: 10001, max: 12000, estSale: 122},
        {min: 12001, max: 15000, estSale: 99},
        {min: 15001, max: 17500, estSale: 88},
        {min: 17501, max: 20000, estSale: 81},
        {min: 20001, max: 25000, estSale: 70},
        {min: 25001, max: 30000, estSale: 57},
        {min: 30001, max: 35000, estSale: 40},
        {min: 35001, max: 50000, estSale: 31},
